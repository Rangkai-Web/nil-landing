...
const slides = [
  ...
  {
    image:
      "https://images.unsplash.com/photo-1554080353-321e452ccf19?q=80&w=2070&auto=format&fit=crop",
    tag: "Unlimited Experience",
    title: "Timeless<br><em>Moments</em><br>Garansi 100%",
      ...
      >
                  ...
                  <div class="max-w-3xl">
                    <div class="overflow-hidden mb-6!">
                      ...
                      >
                        ...
                        <span
                          class="text-[11px] font-bold tracking-[0.3em] uppercase text-white"
                          >{{ slide.tag }}</span
                        >
                      </div>
                    </div>
                    ...
                    >
                      <a
                        href="#gallery"
                        class="px-8! py-4! bg-burg text-white text-[11px] font-bold tracking-widest uppercase hover:bg-burg-light transition-all hover:-translate-y-0.5"
                        >Lihat Portfolio</a
                      >
                      <a
                        href="/reservation"
                        class="px-8! py-4! border border-white/20 text-white text-[11px] font-bold tracking-widest uppercase hover:bg-white hover:text-black transition-all hover:-translate-y-0.5"
        ...
        >
          <button
            ...
            :class="
              currentSlide === index ? 'bg-burg scale-150' : 'bg-white/20'
            "
